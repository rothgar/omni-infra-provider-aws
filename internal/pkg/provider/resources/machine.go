...
import (
	...
	"github.com/siderolabs/omni-infra-provider-aws/api/specs"
	providermeta "github.com/siderolabs/omni-infra-provider-aws/internal/pkg/provider/meta"
)
...
// Machine describes AWS machine configuration.
